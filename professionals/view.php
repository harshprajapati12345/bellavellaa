    ...
    <div class="flex flex-col gap-6 max-w-3xl">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex gap-2">
          <a href="/bellavella/professionals/edit.php?id=<?php echo $id; ?>" class="btn btn-primary text-sm"><i data-lucide="pencil" class="w-4 h-4"></i> Edit</a>
          <a href="/bellavella/professionals/delete.php?id=<?php echo $id; ?>" onclick="return confirm('Delete?')" class="btn btn-danger text-sm"><i data-lucide="trash-2" class="w-4 h-4"></i></a>
        </div>
      </div>
