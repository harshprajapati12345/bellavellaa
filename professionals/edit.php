  ...
  <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto">
    ...
    <div class="flex flex-col gap-6">
      <div class="flex items-center gap-4">
        ...
        <a href="/bellavella/professionals/view.php?id=<?php echo $id; ?>" class="btn btn-secondary text-sm"><i data-lucide="eye" class="w-4 h-4"></i> View</a>
      </div>
      ...
      <form method="POST" enctype="multipart/form-data" class="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div class="flex items-center justify-between px-8 py-5 bg-gray-50/50">
          <a href="/bellavella/professionals/delete.php?id=<?php echo $id; ?>" onclick="return confirm('Delete this professional?')" class="btn btn-danger text-sm"><i data-lucide="trash-2" class="w-4 h-4"></i> Delete</a>
          <div class="flex gap-3"><a href="/bellavella/professionals/" class="btn btn-secondary">Cancel</a><button type="submit" class="btn btn-primary"><i data-lucide="save" class="w-4 h-4"></i> Update</button></div>
        </div>
      </form>
    </div>
  </main>
