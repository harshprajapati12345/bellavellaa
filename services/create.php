<?php
/**
 * services/create.php — Add New Service
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        // TODO: INSERT INTO services (name, category, price, duration, description, status) VALUES (...)
        $success = true;
    }
}
?>
...
<div class="flex min-h-screen">
  ...
  <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto">
    ...
    <div class="flex flex-col gap-6">
      ...
      <?php if ($success): ?><div class="flex items-center gap-3 bg-emerald-50 border border-emerald-200 text-emerald-700 px-5 py-3.5 rounded-2xl text-sm font-medium"><i data-lucide="check-circle" class="w-4 h-4"></i> Service created!</div><?php endif; ?>
      ...
      <form method="POST" enctype="multipart/form-data" class="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="space-y-6">
               ...
               <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                 ...
                 <div>
                    ...
                    <input type="text" name="duration" value="<?php echo htmlspecialchars($_POST['duration'] ?? ''); ?>" placeholder="e.g. 90 mins" class="form-input">
                 </div>
               </div>
               <div>
            ...
            <div class="space-y-6">
               ...
               <div>
                  ...
                  <label class="flex flex-col items-center justify-center w-full h-44 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-gray-400 hover:bg-gray-50 transition-all">
                    ...
                    <p class="text-sm text-gray-400">Upload service image</p>
        ...
        <div class="flex items-center justify-end gap-3 px-8 py-5 bg-gray-50/50">
          ...
          <button type="submit" class="btn btn-primary"><i data-lucide="save" class="w-4 h-4"></i> Save Service</button>
        </div>
      </form>
    </div>
  </main>
