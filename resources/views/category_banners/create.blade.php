@extends('layouts.app')
@php $pageTitle = 'Add Category Banner'; @endphp
...
<div class="flex flex-col gap-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-400 mt-0.5">Create a new banner for a category</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('category-banners.store') }}" enctype="multipart/form-data"
        ...
        <div class="flex items-center justify-end gap-3 px-10 py-6 bg-[#F9F9F9]/50">
            <a href="{{ route('category-banners.index') }}" class="btn btn-secondary">Discard</a>
