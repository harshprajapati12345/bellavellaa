  ...
  <div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('customers.update', $customer->id) }}" method="POST" enctype="multipart/form-data"
      ...
      <div class="p-8 border-b border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="md:col-span-2 space-y-6">
            <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-widest border-b border-gray-100 pb-2 mb-4">
              Personal Details</h3>
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <label
                class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-gray-400 hover:bg-gray-50 transition-all overflow-hidden relative">
                @if($customer->avatar)
            ...
            <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-xl">
              <div>
                ...
                <p class="text-xs text-gray-400">Customer can log in</p>
              </div>
      ...
      <div class="px-8 py-6 bg-gray-50/50 border-t border-gray-100 flex items-center justify-end gap-3">
        ...
        <button type="submit"
          class="bg-black text-white px-8 py-3 rounded-xl hover:bg-gray-800 transition-all font-semibold shadow-lg shadow-black/10">Update
          Customer</button>
      </div>
    </form>
  </div>
