  ...
  <div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <label
                class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-gray-400 hover:bg-gray-50 transition-all">
      ...
      <div class="px-8 py-6 bg-gray-50/50 border-t border-gray-100 flex items-center justify-end gap-3">
        ...
        <button type="submit"
          class="bg-black text-white px-8 py-3 rounded-xl hover:bg-gray-800 transition-all font-semibold shadow-lg shadow-black/10">Create
          Customer</button>
      </div>
    </form>
  </div>
