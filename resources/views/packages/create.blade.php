      ...
      <div class="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden mb-6 section-card">
        ...
        <div class="px-8 pb-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <!-- Right: Image Upload -->
            <div>
              <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 ml-1">Package Image
                <span class="text-red-400">*</span></label>
              <div id="dropZone1"
                class="drop-zone relative flex flex-col items-center justify-center w-full h-44 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-gray-400 hover:bg-gray-50/60 transition-all group"
          ...
          <div class="px-8 pb-8 space-y-5">
            ...
            <div>
              <div id="selectedServicesHeader" class="hidden flex items-center gap-3 mb-3 px-1">
                ...
                <span
                  class="w-28 text-[10px] font-semibold text-gray-400 uppercase tracking-widest text-right">Price</span>
        ...
        <div class="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden mb-6 section-card">
          ...
          <div class="px-8 pb-8 space-y-5">
            ...
            <div>
              <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 ml-1">Package Price
                <span class="text-red-400">*</span></label>
              <div class="relative">
                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-sm text-gray-500 font-semibold">₹</span>
                <input type="number" name="package_price" id="packagePriceInput" value="" placeholder="0.00" min="0"
                  step="0.01"
        ...
        <div class="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden mb-6 section-card">
          ...
          <div class="px-8 pb-8 space-y-5">
            ...
            <div>
              ...
              <div class="border border-gray-200 rounded-2xl overflow-hidden focus-within:border-black/50 transition-all">
                ...
                <div id="descEditor" contenteditable="true"
                  ...
                  data-placeholder="Describe this package and what's included…"></div>
            ...
            <div>
              ...
              <div id="dropZoneDesc"
                class="drop-zone flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-gray-400 hover:bg-gray-50/60 transition-all group"
          ...
          <div class="px-8 pb-8 space-y-5">
            <div>
              ...
              <div class="border border-gray-200 rounded-2xl overflow-hidden focus-within:border-black/50 transition-all">
                ...
                <div id="aftercareEditor" contenteditable="true"
                  ...
                  data-placeholder="Post-service care instructions…"></div>
            ...
            <div>
              ...
              <div id="dropZoneAfter"
                class="drop-zone flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-gray-400 hover:bg-gray-50/60 transition-all group"
        ...
        <!-- STICKY ACTION BAR -->
        <div
          class="sticky bottom-8 z-30 bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-100 shadow-xl px-8 py-4 flex items-center justify-end gap-3 mt-8">
          <a href="{{ route('packages.index') }}"
