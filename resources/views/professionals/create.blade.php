          ...
          <div class="md:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" placeholder="priya@example.com"
                  class="form-input" required>
              </div>
              <div>
                <label class="form-label">Phone *</label>
                <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="+91 98765 43210" class="form-input"
                  required>
              </div>
              <div>
              ...
              <div class="sm:col-span-2">
                ...
                <textarea name="bio" rows="4" placeholder="Brief professional bio…"
                  class="form-input resize-none">{{ old('bio') }}</textarea>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <div class="flex flex-col items-center gap-4">
                <div class="relative">
                  <img id="img-preview"
                    src="https://ui-avatars.com/api/?name=New+Pro&background=f3f4f6&color=6b7280&size=128"
