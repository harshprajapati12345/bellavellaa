                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <div class="color-input-wrapper">
                            <input type="color" name="settings[primary_color]" id="primary_color" value="{{ $primary }}" oninput="updatePreview()">
                    ...
                    <div>
                        ...
                        <div class="color-input-wrapper">
                            <input type="color" name="settings[secondary_color]" id="secondary_color" value="{{ $secondary }}" oninput="updatePreview()">
                    ...
                    <div>
                        ...
                        <div class="color-input-wrapper">
                            <input type="color" name="settings[background_color]" id="background_color" value="{{ $background }}" oninput="updatePreview()">
            ...
            <div class="phone-mockup">
                <div class="phone-screen" id="preview-screen">
                    ...
                    <div class="phone-content space-y-4 p-4">
                        ...
                        <div class="phone-btn text-white shadow-md p-4 rounded-2xl text-center font-bold" id="preview-main-btn">
                            Book Appointment
                        </div>
