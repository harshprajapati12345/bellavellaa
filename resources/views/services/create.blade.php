              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-5">
                  <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Bridal Makeup"
                ...
                <div>
                  ...
                  <div class="relative mt-3 hidden" id="serviceImgPreviewWrap">
                    <img id="serviceImgPreview" class="w-full h-48 object-cover rounded-2xl border border-gray-100" src=""
                      alt="">
          ...
          <div class="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden mb-6 section-card">
            ...
            <div class="px-8 pb-8 space-y-5">
              <div>
                ...
                <input type="text" name="desc_title" value="{{ old('desc_title') }}"
                  placeholder="e.g. Premium Bridal Makeup Experience" class="form-input">
              </div>
              <div>
            ...
            <div class="phone-screen">
              ...
              <div class="phone-status">
                ...
                <div class="flex items-center gap-1">
                  <svg width="10" height="8" viewBox="0 0 10 8" fill="#111">
                    <rect x="0" y="3" width="2" height="5" rx="1" />
                    <rect x="3" y="2" width="2" height="6" rx="1" />
                    <rect x="6" y="1" width="2" height="7" rx="1" />
                    <rect x="9" y="0" width="1" height="8" rx="0.5" />
                  </svg>
                  <svg width="12" height="8" viewBox="0 0 12 8" fill="none" stroke="#111" stroke-width="1.2">
                    <path d="M1 5.5a7.07 7.07 0 0 1 10 0" />
                    <path d="M3.5 7.5a3.54 3.54 0 0 1 5 0" />
                    <circle cx="6" cy="7.5" r="0.8" fill="#111" stroke="none" />
                  </svg>
                  <svg width="20" height="10" viewBox="0 0 20 10" fill="none">
                    <rect x="0.5" y="0.5" width="17" height="9" rx="2.5" stroke="#111" />
                    <rect x="2" y="2" width="12" height="6" rx="1.5" fill="#111" />
                    <path d="M18.5 3.5v3a1.5 1.5 0 0 0 0-3z" fill="#111" />
                  </svg>
                </div>
              </div>
              ...
              <div class="phone-scroll">
                ...
                <div style="display:flex;align-items:center;padding:10px 12px 4px;gap:6px;">
                  <div
                    style="width:22px;height:22px;border-radius:50%;background:#f3f4f6;display:flex;align-items:center;justify-content:center;">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2.5"
                ...
                <div style="padding:4px 14px 10px;">
                  <p id="pv-name" style="font-size:15px;font-weight:700;color:#111;line-height:1.3;margin-bottom:6px;">
                    &mdash;</p>
                  <div style="display:flex;flex-wrap:wrap;gap:5px;align-items:center;">
                    <span id="pv-category" class="preview-badge" style="background:#fdf2f8;color:#be185d;">—</span>
                    <span id="pv-subcategory" class="preview-badge"
                      style="background:#f0fdf4;color:#15803d;display:none;"></span>
                    <span id="pv-duration" class="preview-badge">— min</span>
                  </div>
                  <p id="pv-basic-desc"
                    style="font-size:10px;color:#666;line-height:1.4;margin-top:8px;white-space:pre-wrap;"></p>
                </div>
                ...
                <div style="padding:10px 14px;">
                  <p
                    style="font-size:9px;font-weight:700;color:#aaa;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">
                    Services</p>
                ...
                <!-- Description -->
                <div style="padding:10px 14px;">
                  <p id="pv-desc-title" style="font-size:12px;font-weight:700;color:#111;margin-bottom:8px;">About this
                    service</p>
                  <p id="pv-description"
                    style="font-size:10px;color:#666;line-height:1.5;margin-top:4px;white-space:pre-wrap;"></p>
                </div>
