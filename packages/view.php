 ...
 * Usage: /bellavella/packages/view.php?id=1
 */
    ...
    <div class="flex flex-col gap-6 max-w-3xl">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
          <a href="/bellavella/packages/edit.php?id=<?php echo $id; ?>" class="btn btn-primary text-sm">
            <i data-lucide="pencil" class="w-4 h-4"></i> Edit
          </a>
          <a href="/bellavella/packages/delete.php?id=<?php echo $id; ?>" onclick="return confirm('Delete this package?')" class="btn btn-danger text-sm">
