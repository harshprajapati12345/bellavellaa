    ...
    <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto overflow-x-hidden min-w-0">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 mt-6">
        ...
        <div class="xl:col-span-7 bg-white rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 shadow-[0_2px_20px_rgb(0,0,0,0.02)]">
          ...
          <a href="/bellavella/assign/index.php" class="flex items-center justify-center gap-2 w-full mt-6 py-3 rounded-xl border border-gray-200 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors"><i data-lucide="calendar" class="w-4 h-4"></i> View Full Schedule</a>
        </div>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 mt-6">
        ...
        <div class="xl:col-span-8 bg-white rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 shadow-[0_2px_20px_rgb(0,0,0,0.02)]">
          <div class="flex items-center justify-between mb-6">
            ...
            <a href="/bellavella/assign/index.php" class="text-sm font-medium text-gray-400 hover:text-gray-600 transition-colors">View all →</a>
          </div>
        ...
        <div class="xl:col-span-4 bg-white rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 shadow-[0_2px_20px_rgb(0,0,0,0.02)]">
          ...
          <div class="grid grid-cols-2 gap-3">
            <a href="/bellavella/services/create.php" class="flex flex-col items-center gap-2 p-4 rounded-2xl bg-violet-50 hover:bg-violet-100 transition-colors cursor-pointer group">
            ...
            <a href="/bellavella/professionals/create.php" class="flex flex-col items-center gap-2 p-4 rounded-2xl bg-sky-50 hover:bg-sky-100 transition-colors cursor-pointer group">
            ...
            <a href="/bellavella/packages/create.php" class="flex flex-col items-center gap-2 p-4 rounded-2xl bg-amber-50 hover:bg-amber-100 transition-colors cursor-pointer group">
            ...
            <a href="/bellavella/media/banners.php" class="flex flex-col items-center gap-2 p-4 rounded-2xl bg-pink-50 hover:bg-pink-100 transition-colors cursor-pointer group">
            ...
            <a href="/bellavella/assign/index.php" class="col-span-2 flex items-center justify-center gap-2 p-4 rounded-2xl bg-gray-900 hover:bg-gray-800 transition-colors cursor-pointer group">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 mt-6">
        ...
        <div class="xl:col-span-7 bg-white rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 shadow-[0_2px_20px_rgb(0,0,0,0.02)]">
          <div class="flex items-center justify-between mb-6">
            ...
            <a href="/bellavella/reviews/index.php" class="text-sm font-medium text-gray-400 hover:text-gray-600 transition-colors">Manage Reviews →</a>
          </div>
          <div class="space-y-5">
