...
<main class="lg:ml-72 min-h-screen p-6 sm:p-10">
  ...
  <nav class="flex items-center gap-2 text-sm text-gray-400 mb-8">
    <a href="/bellavella/homepage/" class="hover:text-gray-600 transition-colors">Home Page Manager</a>
    <i data-lucide="chevron-right" class="w-3.5 h-3.5"></i>
    <span class="text-gray-900 font-medium">Edit — <?php echo $section_data['name']; ?></span>
  </nav>

  <form onsubmit="event.preventDefault(); window.location.href='/bellavella/homepage/';" class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-3">
      <a href="/bellavella/homepage/" class="px-6 py-3 border border-gray-200 text-gray-600 text-sm font-medium rounded-xl hover:bg-white transition-colors">Cancel</a>
