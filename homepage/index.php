...
<main class="lg:ml-72 min-h-screen p-6 sm:p-10">
  ...
  <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
    ...
    <a href="/bellavella/homepage/create.php" class="flex items-center gap-2 px-5 py-2.5 bg-black text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors shadow-sm">
  ...
  <div id="sections-list" class="space-y-3">
    ...
    <div class="section-card bg-white rounded-2xl shadow-[0_2px_20px_rgb(0,0,0,0.02)] p-5 flex items-center gap-4"
      ...
      <!-- Edit Button -->
      <a href="/bellavella/homepage/edit.php?id=<?php echo $s['id']; ?>"
