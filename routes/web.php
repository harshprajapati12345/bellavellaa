...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::get('professionals/withdraw-requests', [WithdrawalRequestController::class , 'index'])->name('professionals.withdraw-requests');
    Route::get('professionals/withdraw-history', [WithdrawalRequestController::class , 'history'])->name('professionals.withdraw-history');
    Route::get('admin/professionals/withdraw/{id}/approve', [WithdrawalRequestController::class , 'approve'])->name('admin.professionals.withdraw.approve');
    Route::get('admin/professionals/withdraw/{id}/reject', [WithdrawalRequestController::class , 'reject'])->name('admin.professionals.withdraw.reject');

    // Payout Verifications
    Route::get('professionals/payout-verifications', [PayoutVerificationController::class , 'index'])->name('professionals.payout-verifications');
    Route::post('professionals/payout-verifications/{id}/approve', [PayoutVerificationController::class , 'approve'])->name('professionals.payout-verifications.approve');
    Route::post('professionals/payout-verifications/{id}/reject', [PayoutVerificationController::class , 'reject'])->name('professionals.payout-verifications.reject');
