      ...
      <script>
        ...
        // ── Global Search Logic ──────────────────────────────────────────
        const searchItems = [
            { name: 'Dashboard', url: '/bella/dashboard/', icon: 'layout-grid', category: 'Pages' },
            { name: 'Packages', url: '/bella/packages/', icon: 'shopping-bag', category: 'Inventory' },
            { name: 'Add Package', url: '/bella/packages/create.php', icon: 'plus-circle', category: 'Actions' },
            { name: 'Categories', url: '/bella/categories/', icon: 'grid-3x3', category: 'Inventory' },
            { name: 'Services', url: '/bella/services/', icon: 'store', category: 'Inventory' },
            { name: 'Add Service', url: '/bella/services/create.php', icon: 'plus-circle', category: 'Actions' },
            { name: 'Professionals Overview', url: '/bella/professionals/', icon: 'users', category: 'CRM' },
            { name: 'Verified Professionals', url: '/bella/professionals/index.php?filter=verified', icon: 'shield-check', category: 'CRM' },
            { name: 'Verification Requests', url: '/bella/professionals/verification/', icon: 'badge-check', category: 'CRM' },
            { name: 'Orders', url: '/bella/professionals/orders/', icon: 'shopping-cart', category: 'CRM' },
            { name: 'History', url: '/bella/professionals/history/', icon: 'history', category: 'CRM' },
            { name: 'Users / Customers', url: '/bella/users/', icon: 'user-circle', category: 'CRM' },
            { name: 'Offers & Coupons', url: '/bella/offers/', icon: 'tag', category: 'Marketing' },
            { name: 'Assign Tasks', url: '/bella/assign/', icon: 'clipboard-list', category: 'Workflow' },
            { name: 'Reviews', url: '/bella/reviews/', icon: 'star', category: 'Feedback' },
            { name: 'Homepage Manager', url: '/bella/homepage/', icon: 'layout-template', category: 'Content' },
            { name: 'Banners', url: '/bella/media/banners/', icon: 'gallery-horizontal', category: 'Content' },
            { name: 'Add Banner', url: '/bella/media/banners/create.php', icon: 'image-plus', category: 'Actions' },
            { name: 'Videos', url: '/bella/media/videos/', icon: 'video', category: 'Content' },
            { name: 'Media Library', url: '/bella/media/', icon: 'library', category: 'Content' },
            { name: 'Upload Media', url: '/bella/media/create.php', icon: 'upload', category: 'Actions' }
        ];
