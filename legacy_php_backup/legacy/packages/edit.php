 ...
 * Usage: /bella/packages/edit.php?id=1
 */
  ...
  <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto">
    ...
    <div class="flex flex-col gap-6">
       ...
       <div class="flex items-center gap-4">
        ...
        <a href="/bella/packages/view.php?id=<?php echo $id; ?>" class="btn btn-secondary text-sm">
      ...
      <form method="POST" enctype="multipart/form-data" class="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div class="flex items-center justify-between px-8 py-5 bg-gray-50/50">
          <a href="/bella/packages/delete.php?id=<?php echo $id; ?>" onclick="return confirm('Delete this package?')"
            class="btn btn-danger text-sm">
            <i data-lucide="trash-2" class="w-4 h-4"></i> Delete
          </a>
          <div class="flex items-center gap-3">
            <a href="/bella/packages/" class="btn btn-secondary">Cancel</a>
