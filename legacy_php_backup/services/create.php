  ...
  <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto pb-28">
    ...
    <div class="flex flex-col gap-6">
      ...
      <div class="flex items-center gap-4">
        <a href="/bella/services/" class="w-9 h-9 rounded-xl bg-white border border-gray-200 flex items-center justify-center hover:bg-gray-50 transition-all shadow-sm">
