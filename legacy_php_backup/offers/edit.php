...
<head>
  ...
  <title>Edit Offer · Bellavella Admin</title>
...
<div class="flex min-h-screen relative">
  ...
  <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto">
    <?php $pageTitle = 'Edit Offer'; include '../includes/header.php'; ?>
    ...
    $mockOffer = [
      ...
      'end_date' => '2024-12-31',
      'description' => 'Special discount for first time users on their first booking.',
      'is_active' => true,
      'is_featured' => true,
      'max_usage' => 1000,
      'usage_per_user' => 1
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-400 mb-8">
      <a href="/bella/offers/" class="hover:text-gray-600 transition-colors">Offers</a>
      <i data-lucide="chevron-right" class="w-3.5 h-3.5"></i>
      <span class="text-gray-900 font-medium">Edit Offer</span>
    </nav>
    ...
    <form onsubmit="event.preventDefault(); handleSubmit();" class="w-full">
      <div class="bg-white rounded-[2rem] shadow-[0_2px_20px_rgb(0,0,0,0.03)] border border-gray-100 overflow-hidden">
            ...
            <div class="lg:col-span-2 space-y-8">
              <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div class="sm:col-span-2">
                    ...
                    <input type="text" required value="<?php echo $mockOffer['name']; ?>"
                  ...
                  <div>
                    ...
                    <div class="relative">
                        <input type="text" required uppercase id="offer-code" value="<?php echo $mockOffer['code']; ?>"
                  ...
                  <div>
                    ...
                    <div class="flex p-1 bg-gray-100 rounded-2xl w-full">
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="discount_type" value="flat" <?php echo $mockOffer['discount_type'] === 'flat' ? 'checked' : ''; ?> class="hidden peer">
                        ...
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="discount_type" value="percentage" <?php echo $mockOffer['discount_type'] === 'percentage' ? 'checked' : ''; ?> class="hidden peer">
                            <div class="flex items-center justify-center py-2 text-sm font-semibold rounded-xl transition-all peer-checked:bg-white peer-checked:text-black peer-checked:shadow-sm text-gray-400 hover:text-gray-600">
                                Percentage (%)
                            </div>
                        </label>
                  ...
                  <div>
                    ...
                    <input type="number" required value="<?php echo $mockOffer['discount_value']; ?>"
                      class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400 transition-all">
                  </div>
                  ...
                  <div>
                    ...
                    <input type="number" value="<?php echo $mockOffer['min_order']; ?>"
                      class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400 transition-all">
                  </div>
                  ...
                  <div>
                    ...
                    <input type="date" value="<?php echo $mockOffer['start_date']; ?>"
                      class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400 transition-all">
                  </div>
                  ...
                  <div>
                    ...
                    <input type="date" value="<?php echo $mockOffer['end_date']; ?>"
                      class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400 transition-all">
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <textarea rows="4" 
                    class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400 transition-all resize-none"><?php echo $mockOffer['description']; ?></textarea>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div class="flex items-center justify-between py-4 px-4 bg-gray-50 rounded-2xl mb-4">
                  ...
                  <label class="toggle-switch">
                    <input type="checkbox" <?php echo $mockOffer['is_active'] ? 'checked' : ''; ?>>
                ...
                <div class="flex items-center justify-between py-4 px-4 bg-gray-50 rounded-2xl mb-8">
                  ...
                  <label class="toggle-switch">
                    <input type="checkbox" <?php echo $mockOffer['is_featured'] ? 'checked' : ''; ?>>
                    <span class="toggle-slider"></span>
                  </label>
                </div>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="number" value="<?php echo $mockOffer['max_usage']; ?>"
                    ...
                    <div>
                        ...
                        <input type="number" value="<?php echo $mockOffer['usage_per_user']; ?>"
                            class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400 transition-all">
                    </div>
                </div>
              </div>
        ...
        <div class="px-6 py-5 bg-gray-50/80 border-t border-gray-100 flex items-center justify-end gap-3">
          <a href="/bella/offers/" class="px-6 py-2.5 text-gray-500 text-sm font-medium hover:text-black transition-colors">Discard</a>
...
<script>
  ...
  function handleSubmit() {
    Swal.fire({
      title: 'Offer Updated!',
      text: 'Promotion details have been saved.',
      icon: 'success',
      confirmButtonColor: '#000',
      confirmButtonText: 'Back to Offers'
    }).then(() => {
      window.location.href = '/bella/offers/';
    });
  }
</script>
</body>
