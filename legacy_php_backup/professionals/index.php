...
<div class="flex min-h-screen relative">
  ...
  <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto">
    ...
    <?php
    $professionals = [
      ['id'=>1,'name'=>'Priya Sharma','avatar'=>'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80','category'=>'Luxe','phone'=>'+91 98765 43210','city'=>'Mumbai','status'=>'Active','verification'=>'Verified','orders'=>142,'earnings'=>84200,'commission'=>15,'experience'=>'5 years','joined'=>'2023-06-12','services'=>['HD Bridal Makeup','Party Glam','Gold Facial'],'docs'=>true,'rating'=>4.9],
      ['id'=>2,'name'=>'Anjali Mehta','avatar'=>'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80','category'=>'Prime','phone'=>'+91 87654 32109','city'=>'Delhi','status'=>'Active','verification'=>'Pending','orders'=>67,'earnings'=>32100,'commission'=>12,'experience'=>'3 years','joined'=>'2023-09-01','services'=>['Classic Haircut','Nail Art'],'docs'=>true,'rating'=>4.6],
      ['id'=>3,'name'=>'Sunita Rao','avatar'=>'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80','category'=>'Luxe','phone'=>'+91 76543 21098','city'=>'Bangalore','status'=>'Active','verification'=>'Verified','orders'=>211,'earnings'=>126600,'commission'=>15,'experience'=>'7 years','joined'=>'2023-03-20','services'=>['Hydra Facial','Aromatherapy Massage','Deep Tissue Massage'],'docs'=>true,'rating'=>4.8],
      ['id'=>4,'name'=>'Kavita Joshi','avatar'=>'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80','category'=>'Prime','phone'=>'+91 65432 10987','city'=>'Pune','status'=>'Suspended','verification'=>'Verified','orders'=>34,'earnings'=>15300,'commission'=>12,'experience'=>'2 years','joined'=>'2024-01-05','services'=>['Express Grooming'],'docs'=>true,'rating'=>3.8],
      ['id'=>5,'name'=>'Meera Pillai','avatar'=>'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80','category'=>'Luxe','phone'=>'+91 54321 09876','city'=>'Chennai','status'=>'Active','verification'=>'Rejected','orders'=>0,'earnings'=>0,'commission'=>15,'experience'=>'4 years','joined' => '2024-02-10', 'services' => [], 'docs' => false, 'rating' => 0],
      ['id'=>6,'name'=>'Deepa Nair','avatar'=>'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80','category'=>'Prime','phone'=>'+91 43210 98765','city'=>'Hyderabad','status'=>'Active','verification'=>'Verified','orders'=>89,'earnings'=>44500,'commission'=>12,'experience'=>'4 years','joined'=>'2023-11-15','services'=>['Weekend Rejuvenation','Nail Art Deluxe'],'docs'=>true,'rating'=>4.7],
    ];
    ...
    <div class="flex flex-col gap-6">
      ...
      <div class="bg-white rounded-2xl p-3 shadow-[0_2px_16px_rgba(0,0,0,0.04)] flex flex-wrap items-center gap-1.5">
        <?php foreach(['all'=>'All','verified'=>'Verified','pending'=>'Pending','rejected'=>'Rejected','active'=>'Active','suspended'=>'Inactive'] as $k=>$v): ?>
...
<script>
  ...
  function openDrawer(pro) {
    ...
    // Add star icon if rating is available
    if (pro.rating > 0) {
      document.getElementById('d-rating').innerHTML += ' <i data-lucide="star" class="w-4 h-4 text-amber-400 fill-amber-400 inline-block mb-1"></i>';
    }
