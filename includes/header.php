      ...
      <script>
        ...
        // ── Global Search Logic ──────────────────────────────────────────
        const searchItems = [
            { name: 'Dashboard', url: '/bellavella/dashboard/', icon: 'layout-grid', category: 'Pages' },
            { name: 'Packages', url: '/bellavella/packages/', icon: 'shopping-bag', category: 'Inventory' },
            { name: 'Add Package', url: '/bellavella/packages/create.php', icon: 'plus-circle', category: 'Actions' },
            { name: 'Categories', url: '/bellavella/categories/', icon: 'grid-3x3', category: 'Inventory' },
            { name: 'Services', url: '/bellavella/services/', icon: 'store', category: 'Inventory' },
            { name: 'Add Service', url: '/bellavella/services/create.php', icon: 'plus-circle', category: 'Actions' },
            { name: 'Professionals Overview', url: '/bellavella/professionals/', icon: 'users', category: 'CRM' },
            { name: 'Verified Professionals', url: '/bellavella/professionals/index.php?filter=verified', icon: 'shield-check', category: 'CRM' },
            { name: 'Verification Requests', url: '/bellavella/professionals/verification/', icon: 'badge-check', category: 'CRM' },
            { name: 'Orders', url: '/bellavella/professionals/orders/', icon: 'shopping-cart', category: 'CRM' },
            { name: 'History', url: '/bellavella/professionals/history/', icon: 'history', category: 'CRM' },
            { name: 'Users / Customers', url: '/bellavella/users/', icon: 'user-circle', category: 'CRM' },
            { name: 'Offers & Coupons', url: '/bellavella/offers/', icon: 'tag', category: 'Marketing' },
            { name: 'Assign Tasks', url: '/bellavella/assign/', icon: 'clipboard-list', category: 'Workflow' },
            { name: 'Reviews', url: '/bellavella/reviews/', icon: 'star', category: 'Feedback' },
            { name: 'Homepage Manager', url: '/bellavella/homepage/', icon: 'layout-template', category: 'Content' },
            { name: 'Banners', url: '/bellavella/media/banners/', icon: 'gallery-horizontal', category: 'Content' },
            { name: 'Add Banner', url: '/bellavella/media/banners/create.php', icon: 'image-plus', category: 'Actions' },
            { name: 'Videos', url: '/bellavella/media/videos/', icon: 'video', category: 'Content' },
            { name: 'Media Library', url: '/bellavella/media/', icon: 'library', category: 'Content' },
            { name: 'Upload Media', url: '/bellavella/media/create.php', icon: 'upload', category: 'Actions' }
        ];
