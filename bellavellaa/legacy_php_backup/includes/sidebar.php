...
$section = '';
if (preg_match('#/bella/([^/?]+)#', $urlPath, $m)) {
    $section = $m[1];
} elseif (basename($_SERVER['PHP_SELF']) === 'index.php' && strpos($urlPath, '/bella/') !== false && substr_count(trim(str_replace('/bella/', '', $urlPath), '/'), '/') === 0) {
    $section = 'dashboard';
}
// Sub-section for professionals and media
$subSection = '';
if (preg_match('#/bella/[^/]+/([^/?]+)#', $urlPath, $m2)) {
...
?>
<aside id="sidebar"
      class="w-72 fixed h-screen top-0 left-0 flex flex-col justify-between p-6 z-50 bg-[#F6F6F6] transition-transform duration-300 -translate-x-full lg:translate-x-0 border-r border-gray-200 lg:border-none shadow-2xl lg:shadow-none overflow-y-auto scrollbar-hide">
      <div>
        <!-- Logo area -->
        ...
        <nav class="space-y-1">
          ...
          <div class="relative">
            ...
            <div id="professionals-submenu" class="submenu<?php echo $isProActive ? ' open' : ''; ?> pl-4 mt-1 space-y-1">
              ...
              <a href="/bella/professionals/verification/"
              ...
              <a href="/bella/professionals/orders/"
              ...
              <a href="/bella/professionals/history/"
              ...
              <a href="/bella/professionals/leaves/"
                class="flex items-center gap-3 px-4 py-2.5 <?php echo ($section === 'professionals' && $subSection === 'leaves') ? 'bg-white text-black shadow-sm ring-1 ring-gray-200' : 'hover:bg-white text-black'; ?> rounded-xl transition-all group sidebar-item-hover">
              ...
              <p class="px-4 py-1 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Kit Management</p>

              <a href="/bella/professionals/kit-products/"
                class="flex items-center gap-3 px-4 py-2.5 <?php echo ($section === 'professionals' && $subSection === 'kit-products') ? 'bg-white text-black shadow-sm ring-1 ring-gray-200' : 'hover:bg-white text-black'; ?> rounded-xl transition-all group sidebar-item-hover">
              ...
              <a href="/bella/professionals/kit-orders/"
                class="flex items-center gap-3 px-4 py-2.5 <?php echo ($section === 'professionals' && $subSection === 'kit-orders' && basename($_SERVER['PHP_SELF']) === 'index.php') ? 'bg-white text-black shadow-sm ring-1 ring-gray-200' : 'hover:bg-white text-black'; ?> rounded-xl transition-all group sidebar-item-hover">
                <i data-lucide="layout-grid" class="w-4 h-4 text-black opacity-70 group-hover:opacity-100"></i>
                <span class="font-normal text-sm text-black">Kit Inventory</span>
              </a>
              <a href="/bella/professionals/kit-orders/manage.php"
                class="flex items-center gap-3 px-4 py-2.5 <?php echo ($section === 'professionals' && $subSection === 'kit-orders' && basename($_SERVER['PHP_SELF']) === 'manage.php') ? 'bg-white text-black shadow-sm ring-1 ring-gray-200' : 'hover:bg-white text-black'; ?> rounded-xl transition-all group sidebar-item-hover">
                <i data-lucide="truck" class="w-4 h-4 text-black opacity-70 group-hover:opacity-100"></i>
                <span class="font-normal text-sm text-black">Order Management</span>
              </a>
            </div>
          </div>
          ...
          <!-- Settings -->
          <a href="/bella/settings/"
            class="flex items-center gap-3 px-4 py-3 <?php echo $section === 'settings' ? 'bg-white text-black shadow-sm ring-1 ring-gray-200' : 'hover:bg-white text-black'; ?> rounded-xl transition-all group sidebar-item-hover">
