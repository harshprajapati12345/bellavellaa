  ...
  <div class="bg-white rounded-2xl sm:rounded-[2rem] shadow-[0_2px_20px_rgb(0,0,0,0.02)] p-5 sm:p-6 mb-6">
    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
      ...
      <div class="flex flex-wrap items-center gap-3 w-full lg:w-auto">
        <a href="/bellavella/media/banners/" class="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all">
          <i data-lucide="image" class="w-4 h-4"></i>
          Banners
        </a>
        <a href="/bellavella/media/videos/" class="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all">
          ...
          <tr class="table-row border-b border-gray-50">
            ...
            <td class="px-4 py-4 text-right">
              <div class="flex items-center justify-end gap-1">
                <a href="/bellavella/media/edit.php?id=<?php echo $m['id']; ?>" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-black hover:bg-gray-100 transition-colors" title="Edit">
