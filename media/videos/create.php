...
<div class="flex min-h-screen relative">
  ...
  <main class="flex-1 lg:ml-72 p-4 lg:p-8 overflow-y-auto">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-400 mb-8">
      <a href="/bellavella/media/videos/" class="hover:text-gray-600 transition-colors">Videos</a>
    ...
    <form onsubmit="event.preventDefault(); handleSubmit();">
            ...
            <div class="upload-zone rounded-2xl p-8 text-center cursor-pointer h-[calc(100%-40px)]" id="video-dropzone" onclick="document.getElementById('video-input').click()">
              ...
              <div id="video-placeholder">
                ...
                <div class="flex flex-wrap items-center justify-center gap-2 mt-4">
                  ...
                  <span class="text-[10px] text-purple-500 bg-purple-50 px-2.5 py-1 rounded-full">🎞️ Video Only</span>
                </div>
              </div>
      ...
      <div class="flex items-center justify-between">
        <a href="/bellavella/media/videos/" class="px-6 py-3 border border-gray-200 text-gray-600 text-sm font-medium rounded-xl hover:bg-white transition-colors">Cancel</a>
...
<script>
  ...
  function handleSubmit() {
    Swal.fire({
      ...
      window.location.href = '/bellavella/media/videos/';
    });
  }
